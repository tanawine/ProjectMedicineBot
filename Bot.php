	...
	if (!is_null($events['events'])) {
		...
		foreach ($events['events'] as $event) {
		 ...
		 if (strpos( $textUser,"จ้า") ||  $event['message']['text'] == "จ้า" ) { //&& $event['message']['text'] == "ไร"
				...
				$text = "ถ้าอาการไอแบบมีเสมหะ หมอแนะนำว่า ให้ใช้ตัวยาที่มีส่วนประกอบของ Guaifenesin ซึ่งช่วยบรรเทาอาการไอชนิดมีเสมหะโดยยาที่หาซื้อได้ทั่วไปคือ Bromhexine หรือ Bisolvon กรณี อาการไอแบบไม่มีเสมหะ หมอแนะนำว่าดูแลสุขภาพตัวเอง ดื่มน้ำอุ่นก็จะช่วยบรรเทาอาการได้ครับ และควรงดอาหารรสเผ็ดจัด น้ำแข็ง น้ำเย็นจัด ของทอด เหล้าและบุหรี่ครับ (กรณี อยากเห็นภาพตัวอย่างยา พิมพ์คำว่า Bromhexine หรือ Bisolvon)";
