	...
	if (!is_null($events['events'])) {
		...
		foreach ($events['events'] as $event) {
		 ...
		 if (strpos( $textUser,"จ้า") ||  $event['message']['text'] == "จ้า" ) { //&& $event['message']['text'] == "ไร"
				...
				\n*กรณีอยากเห็นรูปตัวอย่างยาให้พิมพ์คำว่า plaster หรือ ยาแก้ปวดเมื่อย  \n**กรณีอยากทราบวิธีดูแลอาการปวดเมื่อย พิมพ์  ปวดเมื่อยTC\n**กรณีอยากทราบ ความแตกต่างของยาบรรเทาอาการปวดอักเสบกล้ามเนื้อ แบบร้อน และ แบบเย็น  พิมพ์  แตกต่างยาแก้ปวดเมื่อย";
