...
//เริม		
				 ...
				 ||(strpos( $textUser,"ตุ่มพอง") && strpos( $textUser,"ผิวหนัง"))
				  ||(strpos( $textUser,"ตุ่มพอง") && strpos( $textUser,"ไข้"))
