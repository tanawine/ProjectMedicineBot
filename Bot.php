...
//ไข้
				...
				} else if ( strpos($textUser,"ไข้")&&strpos($textUser,"ยังไง") ){
					$text = " วิธีดูแลตัวเองถ้าหากเป็นไข้นะครับ \n1 พักผ่อนให้เพียงพอ รับประทานอาหารที่มีประโยชน์ ดื่มน้ำมากๆ และทานยาให้ตรงตามเวลา\n2 ตรวจวัดอุณหภูมิอยู่เสมอทุกๆ 6 ถึง 8 ชั่วโมง หรือตรวจเมื่อสงสัยว่าไข้ขึ้นหรือหากไข้สูงเกิน 40 องศา ควรพบแพทย์โดยด่วน\n3  ทำร่างกายให้อบอุ่น และไม่อาบน้ำเย็น ";
				}
